...
def execution(delta):
    ...
    global drawable_objects
    recalculate_space_objects_positions([obj for obj in space_objects], delta)
    drawable_objects = [DrawableObject(obj) for obj in space_objects]
...
def main():
    ...
    while alive:
        ...
        last_time = cur_time
        drawer.update(drawable_objects, box)
        time.sleep(1.0 / 60)
